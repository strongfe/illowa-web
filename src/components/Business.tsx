...
import { businessByLocale, resolveLocalized } from '@/data/content/localeData';

export default function Business() {
    const locale = useLocale();
    const content = resolveLocalized(businessByLocale, locale);

    return (
        <section className="py-24 px-5 bg-dark border-t border-[#222]">
